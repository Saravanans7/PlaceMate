...
import { listDrives, createDrive, getDrive, getDriveWithStudentProgress, getStudentPlacementStatus, addAnnouncement, shortlistRound, roundResults, finalizeDrive, backfillTodayDrives, getOrCreateDriveByRegistration, updateDrive, deleteDrive } from '../controllers/driveController.js';
...
router.get('/student/:id/placement-status', authMiddleware, getStudentPlacementStatus);
